...
Точка $P$ принадлежит лучу $AB$, если принадлежит прямой и $\vec{AB}$ со-направлен с $\vec{AP}$.
...
Точка $P$ принадлежит отрезку $AB$, если она принадлежит лучу и $\vec{BA}$ со-направлен с $\vec{BP}$.
